...
export function isSafeBinUsage(params: {
  ...
  // When the user explicitly added a bin to safeBins but no profile exists,
  // trust it unconditionally — the explicit opt-in is sufficient.
  // Profiled bins still go through strict argv validation.
  if (!profile) {
    return true;
  }
